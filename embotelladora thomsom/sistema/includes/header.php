...
<head>
	...
	<title>Sistema de embotelladora thomsom</title>
			...
			<div class="container-fluid d-flex align-items-center justify-content-between">
				<div class="navbar-header">
					<!-- Navbar Header--><a href="index.php" class="navbar-brand">
						<div class="brand-text brand-big visible text-uppercase"><strong >Inicio</strong></div>
						<div class="brand-text brand-sm"><strong>INI</strong></div>
					</a>
					<!-- Sidebar Toggle Btn-->
	...
	<div class="d-flex align-items-stretch">
		...
		<nav id="sidebar">
			...
			<div class="sidebar-header d-flex align-items-center">
				<div class="avatar"><img src="img/logo.jpg" width="500px" alt="..." class="img-fluid rounded-circle"></div>
				<div class="title">
					<h1 class="h5"></h1>
