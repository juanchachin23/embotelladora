...
<head>
  ...
  <title>Embotelladora Thomson</title>
  ...
  <link href="sistema/css/style.violet.css" rel="stylesheet">
	...
	#contenedor_form {
	background-color: #0faaf7 !important;
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div id="contenedor_form" class="row">
                ...
                <div class="p-5">
                  ...
                  <form class="user" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Digite usuario" name="usuario"></div>
                    <div class="form-group">
                      <label for="">Contraseña</label>
                      <input type="password" class="form-control" placeholder="Digite contraseña" name="clave">
                    </div>
